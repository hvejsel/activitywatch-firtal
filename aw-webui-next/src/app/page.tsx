...
import { Clock, Activity, GitBranch, Package } from "lucide-react";
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Connect to ActivityWatch to see your activity data.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Most used apps today</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
